...
namespace MealOrdering.Server.Services.Services
{
    public class SupplierService : ISupplierService
    {
        ...
        public async Task<List<SuppliersDto>> GetSuppliers()
        {
        ...
        public async Task<SuppliersDto> CreateSupplier(SuppliersDto Supplier)
        {
            var dbSupplier = mapper.Map<MealOrdering.Server.Data.Models.Suppliers>(Supplier);
            await context.AddAsync(dbSupplier);
            await context.SaveChangesAsync();

            return mapper.Map<SuppliersDto>(dbSupplier);
        }

        public async Task<SuppliersDto> UpdateSupplier(SuppliersDto Supplier)
        {
        ...
        public async Task<SuppliersDto> GetSupplierById(Guid Id)
        {
