...
namespace MealOrdering.Client.Pages.PageProcess
{
    public class SupplierBusiness : ComponentBase
    {
        ...
        protected List<SuppliersDto> SupplierList;
        ...
        {
            var res = await Http.GetFromJsonAsync<ServiceResponse<List<SuppliersDto>>>($"api/Supplier/Suppliers");

            SupplierList = res.Success && res.Value != null ? res.Value : new List<SuppliersDto>();
        }
